...
export default function SingleChoince2Question(props: QuestionProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      { props.question.questionPart1 && 
      <View>
        <Text style={[styles.BricolageGrotesque, styles.answer]}>{props.question.questionPart1}:</Text>
        <RadioButton
          option1={{
            answerIndex: 0,
      ...
      { props.question.questionPart2 && 
      <View>
        <Text style={[styles.BricolageGrotesque,styles.answer]}>{props.question.questionPart2}:</Text>
        <RadioButton
          option1={{
            answerIndex: 2,
          ...
          option2={{
            answerIndex: 3,
            label: props.question.answers[3].label
          }}
          currentQuestionUuid={props.question.uuid}
          onAnswer={onAnswer}
        />
